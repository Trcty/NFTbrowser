...
const ModalContent = ({ nft }) => {
  ...
  }, []); // 2nd param is empty means 1st param runs once after first rendering
  ...
  return (
    <>
      <Tooltip title="Transfer(s) on this NFT">
        {/* The tip is shown on mouse enter, and is hidden on mouse leave. To provide an explanation of a button/text/operation */}
        <Button
          style={{ border: "none" }}
          size="large"
          shape="circle"
      ...
      <Modal
        //   弹窗 create a new floating layer over the current page to get user feedback or display information.
        width={1000}
